...
KeyMapping key_table[] = {
    {"ESC", 0x01, 27, -1, 27},
    {"F1", 0x3B, -1, -1, -1}, {"F2", 0x3C, -1, -1, -1}, {"F3", 0x3D, -1, -1, -1}, 
    {"F4", 0x3E, -1, -1, -1}, {"F5", 0x3F, -1, -1, -1}, {"F6", 0x40, -1, -1, -1},
    {"F7", 0x41, -1, -1, -1}, {"F8", 0x42, -1, -1, -1}, {"F9", 0x43, -1, -1, -1},
    {"F10", 0x44, -1, -1, -1}, {"F11", 0x57, -1, -1, -1}, {"F12", 0x58, -1, -1, -1},

    {"1", 0x02, '1', '!', -1}, {"2", 0x03, '2', '@', 0}, {"3", 0x04, '3', '#', -1},
    {"4", 0x05, '4', '$', -1}, {"5", 0x06, '5', '%', -1}, {"6", 0x07, '6', '&', 30},
    {"7", 0x08, '7', '/', -1}, {"8", 0x09, '8', '(', -1}, {"9", 0x0A, '9', ')', -1},
    {"0", 0x0B, '0', '=', -1}, {"-", 0x0C, '-', '_', 31}, {"=", 0x0D, '=', '+', -1},
    {"Backspace", 0x0E, 8, -1, 8},

    {"Tab", 0x0F, 9, -1, 9}, 
    {"Q", 0x10, 'Q', -1, 17}, {"W", 0x11, 'W', -1, 23}, {"E", 0x12, 'E', -1, 5},
    {"R", 0x13, 'R', -1, 18}, {"T", 0x14, 'T', -1, 20}, {"Y", 0x15, 'Y', -1, 25},
    {"U", 0x16, 'U', -1, 21}, {"I", 0x17, 'I', -1, 9}, {"O", 0x18, 'O', -1, 15},
    {"P", 0x19, 'P', -1, 16}, {"[", 0x1A, '[', '{', 27}, {"]", 0x1B, ']', '}', 29},
    {"Enter", 0x1C, 13, -1, 10},

    {"A", 0x1E, 'A', -1, 1}, {"S", 0x1F, 'S', -1, 19}, {"D", 0x20, 'D', -1, 4},
    {"F", 0x21, 'F', -1, 6}, {"G", 0x22, 'G', -1, 7}, {"H", 0x23, 'H', -1, 8},
    {"J", 0x24, 'J', -1, 10}, {"K", 0x25, 'K', -1, 11}, {"L", 0x26, 'L', -1, 12},
    {";", 0x27, ';', ':', -1}, {"'", 0x28, '\'', '\"', -1}, {"º", 0x29, '.', '|', -1},

    {"Shift Izq.", 0x2A, -1, -1, -1}, {"\\", 0x2B, '\\', '|', 28},
    {"Z", 0x2C, 'Z', -1, 26}, {"X", 0x2D, 'X', -1, 24}, {"C", 0x2E, 'C', -1, 3},
    {"V", 0x2F, 'V', -1, 22}, {"B", 0x30, 'B', -1, 2}, {"N", 0x31, 'N', -1, 14},
    {"M", 0x32, 'M', -1, 13}, {",", 0x33, ',', '<', -1}, {".", 0x34, '.', '>', -1},
    {"/", 0x35, '/', '?', -1}, {"Shift Der.", 0x36, -1, -1, -1},

    {"Ctrl Izq.", 0x1D, -1, -1, -1}, {"Alt Izq.", 0x38, -1, -1, -1},
    {"Espacio", 0x39, ' ', ' ', 0}, {"Alt Der.", 0x38, -1, -1, -1},
    {"Ctrl Der.", 0x1D, -1, -1, -1},

    {"Flecha Arriba", 0x48, -1, -1, -1},
    {"Flecha Izquierda", 0x4B, -1, -1, -1},
    {"Flecha Derecha", 0x4D, -1, -1, -1},
    {"Flecha Abajo", 0x50, -1, -1, -1},

    {"Insert", 0x52, -1, -1, -1}, {"Delete", 0x53, -1, -1, -1},
    {"Inicio", 0x47, -1, -1, -1}, {"Fin", 0x4F, -1, -1, -1},
    {"Re Pág", 0x49, -1, -1, -1}, {"Av Pág", 0x51, -1, -1, -1},
